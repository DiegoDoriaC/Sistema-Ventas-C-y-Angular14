...
namespace SistemaVenta.BLL.Servicios
{
    public class VentaService : IVentaService
    {
        ...
        public VentaService(IVentaRepository ventaRepository, IGenericRepository<DetalleVenta> repository, IMapper mapper)
        {
        ...
        public async Task<VentaDTO> Registrar(VentaDTO modelo)
        {
            try
            {
                ...
                if (ventaGenerada.IdVenta == 0) throw new TaskCanceledException("La venta no se pudo registrar");
        ...
        {
            IQueryable<DetalleVenta> query = await _repository.Consultar();
